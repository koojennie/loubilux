    ...
    return (
        ...
        <div className="bg-white p-6 rounded shadow-md">
          ...
          <div className="p-6 pt-0 text-center">
              ...
              <button type="button" className="text-white bg-gradient-to-br from-green-400 to-green-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center shadow-md shadow-gray-300 hover:scale-[1.02] transition-transform"
              onClick={onConfirm}
              >
                  Yes, I'm sure
              </button>
